...
function Contact({ sectionRef, Home }) {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full flex flex-col gap-y-10 h-fit p-2 my-10"
    >
      <div className={styles.header}>
        <h1
          onClick={() => scrollToSection(Home)}
          className="text-center text-[4rem] font-medium tracking-[1%]"
        >
          GET IN TOUCH
        </h1>
        <span></span>
      ...
      <div className="relative flex flex-wrap md:flex-row-reverse">
        ...
        >
          ...
          <h6 className="text-[22px] font-medium tracking-[1%]">{localTime}</h6>
        </motion.div>
        <motion.div
